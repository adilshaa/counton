...
const ControlsPanel = ({
  ...
  return (
    <div
      className={`h-full bg-white/70 dark:bg-gray-900/30 backdrop-blur-xl border-r border-gray-200/80 dark:border-gray-700/20 transition-all duration-300 ease-in-out shadow-2xl flex flex-col ${
    ...
    >
      <div className={`flex-1 overflow-y-auto`}>
        ...
        >
          ...
          {/* Navigation Buttons */}
          <div className="bg-gray-200/50 dark:bg-gray-800/30 backdrop-blur-xl rounded-xl p-1.5 border border-gray-300/70 dark:border-gray-700/20 transition-colors duration-300">
            <div className="flex flex-col space-y-1.5">
              <button
                onClick={() => setActiveModal("settings")}
                title={isSidebarCollapsed ? "Settings" : undefined}
                className={`flex items-center justify-center sm:justify-start gap-3 ${
                  isSidebarCollapsed ? "p-3" : "px-4 py-2.5"
      ...
      <div className="border-t border-gray-300/60 dark:border-gray-700/20">
        {/* UserButton section */}
        <div
          className={`${
            isSidebarCollapsed ? "py-3 flex justify-center" : "p-3"
          }`}
        >
        ...
        {/* Toggle Button */}
        <div className={`${isSidebarCollapsed ? "px-3 pb-3" : "p-3"}`}>
          <button
